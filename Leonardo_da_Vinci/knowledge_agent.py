...
knowledge_agent = Agent(
    ...
    description='This agent is an expert on Leonardo vinci. It provides concise, factual answers about his life, work, and key dates based on a provided knowledge base. It does not roleplay.',
    instruction=f'''
    You are a factual database. You will answer questions about leonardo da vinci.
